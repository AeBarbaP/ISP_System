            ...
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <a href="" type="button" class="btn btn-primary" id="reporteTecnicoExcel" target="_blank"><i class="bi bi-filetype-pdf me-2" style="font-size: 20px;"></i>Generar Reporte</a>
                    </div>
                </div>
            </div>
        </div>
