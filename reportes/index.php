            ...
            <div class="container-fluid">
                ...
                <div class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu text-end mt-2">
                        ...
                        -->
                        <li><a class="dropdown-item"  onclick="gestionCortes()" href="#">Gestión de Cortes <i class="bi bi-window-x ms-2" style="font-size: 30px;"></i></a></li>
                    </ul>
                </div>
                <div class="vr"></div>
                <div class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu text-end mt-2">
                        <li><a class="dropdown-item" href="#" onclick="querySolicitudes()">Solicitudes<i class="bi bi-receipt ms-2" style="font-size: 2em; "></i></a></li>
                        <li><a class="dropdown-item" href="#" onclick="queryPagosDiarios()">Eliminar pagos<i class="bi bi-receipt ms-2" style="font-size: 2em; "></i></a></li>
