...
$sqlTotal = "SELECT COUNT(*) as total FROM pagos_generales WHERE (MONTH(fecha_pago) = MONTH(CURRENT_DATE()) AND YEAR(fecha_pago) = YEAR(CURRENT_DATE())) AND id_ext = '$usr'";
$resultadoTotal = $conn->query($sqlTotal);
$totalRegistros = $resultadoTotal->fetch_assoc()['total'];
$totalPaginas = ceil($totalRegistros / $registrosPorPagina);

// Consulta principal con paginación
$sql = "SELECT * FROM pagos_generales WHERE (MONTH(fecha_pago) = MONTH(CURRENT_DATE()) AND YEAR(fecha_pago) = YEAR(CURRENT_DATE())) AND id_ext = '$usr' ORDER BY folio_pago DESC LIMIT $offset, $registrosPorPagina";
