<?php
    ...
    class PDF extends FPDF {
        ...
        function Header() {
            if ($this->PageNo() == 1) {
                // Logo más compacto
                $this->Image('../../images/logo_conectwi_wide-removebg-preview.png', ($this->GetPageWidth() - 70) / 2, 8, 70);
        ...
        function TablaEjecutiva($header, $data, $widths, $subtotal, $title) {
            ...
            $this->Cell($anchoTotal - $widths[count($widths)-1], 5, 'SUBTOTAL:', 1, 0, 'R', true);
    ...
    // Tabla 1: Pagos Generales en efectivo
